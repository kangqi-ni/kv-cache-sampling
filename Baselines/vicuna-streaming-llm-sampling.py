    ...
    for file_name in key_data_pairs:
        ...
        for d in tqdm(data):
            ...
            for inst, out in zip(instructions, outputs):
                ...
                past_key_values = kv_cache.evict_for_space(past_key_values, space_needed, kv_cache.past_attentions)
                ...
                if "sci_fi" in file_name:
                    ...
                    space_needed = inputs.input_ids.shape[-1] + max_new_tokens
                    past_key_values = kv_cache.evict_for_space(past_key_values, kv_cache.past_attentions, space_needed)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sampling', action='store_true', help='set this if you want to use streaming llm with sampling')
